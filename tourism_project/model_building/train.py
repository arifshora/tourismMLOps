...
Xtrain_path = "hf://datasets/arifshora/tourism-mlops/Xtrain.csv"
Xtest_path = "hf://datasets/arifshora/tourism-mlops/Xtest.csv"
ytrain_path = "hf://datasets/arifshora/tourism-mlops/ytrain.csv"
ytest_path = "hf://datasets/arifshora/tourism-mlops/ytest.csv"
...
categorical_features = [
    ...
    'Passport',           # Whether the customer holds a valid passport (0
    'OwnCar',             # Whether the customer owns a car (0
...
with mlflow.start_run():
    ...
    repo_id = "arifshora/tourism-model"
    repo_type = "model"
